      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center space-x-6">
          <div className="text-gray-300">
            <span className={`mr-4 px-3 py-1 rounded-full text-sm ${batteryPercent > 50 ? 'bg-green-700' : batteryPercent > 20 ? 'bg-yellow-600' : 'bg-red-600'}`}>Battery: {batteryPercent}%</span>
