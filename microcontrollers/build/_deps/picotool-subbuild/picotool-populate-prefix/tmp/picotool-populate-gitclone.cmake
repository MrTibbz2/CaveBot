...
if(EXISTS "C:/Users/Lachlan/innovation-team-2/microcontrollers/build/_deps/picotool-subbuild/picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-gitclone-lastrun.txt" AND EXISTS "C:/Users/Lachlan/innovation-team-2/microcontrollers/build/_deps/picotool-subbuild/picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-gitinfo.txt" AND
  ...
  message(VERBOSE
    ...
    "'C:/Users/Lachlan/innovation-team-2/microcontrollers/build/_deps/picotool-subbuild/picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-gitclone-lastrun.txt'"
  )
  return()
endif()
...
execute_process(
  COMMAND ${CMAKE_COMMAND} -E rm -rf "C:/Users/Lachlan/innovation-team-2/microcontrollers/build/_deps/picotool-src"
  RESULT_VARIABLE error_code
  ${maybe_show_command}
)
if(error_code)
  message(FATAL_ERROR "Failed to remove directory: 'C:/Users/Lachlan/innovation-team-2/microcontrollers/build/_deps/picotool-src'")
endif()
...
while(error_code AND number_of_tries LESS 3)
  execute_process(
    ...
    WORKING_DIRECTORY "C:/Users/Lachlan/innovation-team-2/microcontrollers/build/_deps"
    RESULT_VARIABLE error_code
    ${maybe_show_command}
  )
...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe"
          checkout "develop" --
  WORKING_DIRECTORY "C:/Users/Lachlan/innovation-team-2/microcontrollers/build/_deps/picotool-src"
  RESULT_VARIABLE error_code
  ${maybe_show_command}
)
if(error_code)
...
if(error_code)
  message(FATAL_ERROR "Failed to update submodules in: 'C:/Users/Lachlan/innovation-team-2/microcontrollers/build/_deps/picotool-src'")
endif()
...
if(error_code)
  message(FATAL_ERROR "Failed to copy script-last-run stamp file: 'C:/Users/Lachlan/innovation-team-2/microcontrollers/build/_deps/picotool-subbuild/picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-gitclone-lastrun.txt'")
endif()
